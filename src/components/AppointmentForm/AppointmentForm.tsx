...
const CreateAppointmentForm: React.FC = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <label>
        Patient Name:
        <input {...register("patientName", { required: "Patient name is required" })} />
        {errors.patientName && <p>{errors.patientName.message}</p>}
      </label>
      <label>
        Doctor or Department:
        <input {...register("doctor", { required: "Doctor's name is required" })} />
      ...
      <label>
        Contact Info:
        <input {...register("contactInfo", { required: "Contact info is required" })} />
